// Artchitect: taken from https://github.com/blackjack/webcam/blob/master/examples/http_mjpeg_streamer/webcam.go.
// Thanks, blackjack!
...
func main() {
	...
	//single := flag.Bool("m",
	//	false, "single image http mode, default mjpeg video")
