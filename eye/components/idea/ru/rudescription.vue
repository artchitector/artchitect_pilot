<template>
  <section class="content">
    ...
    <blockquote class="mb-0">
      Машина не знает, что ей рисовать, у неё нет подсознания. Машина ни к чему не стремится, у неё нет своих идей о том, что вообще делать.<br/>
      Идея проекта Artchitect - дать машине воображение, подсознание и творческую случайность.
    </blockquote>
    <p class="mb-0">
      <br/>
      Artchitect/Архитектор получает ответы на свои вопросы из окружающего пространства, считывая их через веб-камеру. Так он и
      ...
      <br/>
      <br/>
      Архитектор постоянно общается с фоновым пространством (энтропией), задавая вопросы и получая ответы.
      <br/>
      <br/>
