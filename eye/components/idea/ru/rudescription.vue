<template>
  <section class="content">
    ...
    <blockquote class="mb-0">
      Машина не знает, что ей рисовать. У неё нет своих идей, что делать.
    </blockquote>
    <p class="mb-0">
      <br/>
      Архитектор получает ответы на свои вопросы из окружающего пространства, считывая их через веб-камеру. Так он и
      решает, что будет рисовать.
      Кадр с веб-камеры преобразуется в int64-число (используется световой фоновый шум на кадре, меняющийся каждый
      момент).
      Это число и нужно Архитектору, чтобы принять конкретное решение.
      <br/>
      <br/>
      Artchitect постоянно общается с фоновым пространством (энтропией), задавая вопросы и получая ответы.
      <br/>
      <br/>
      На языке человеческого общения построение каждой картины выглядит так:
    </p>
    <p class="pl-4">
      <br/> <i>Artchitect:</i> Привет! Я начинаю рисовать картину номер #271165.
      ...
      <br/>
      <br/>
      Далее Artchitect отправляет полученные решения на вход Stable Diffusion AI и получает изображение.<br/>Так Artchitect
      создал картину
